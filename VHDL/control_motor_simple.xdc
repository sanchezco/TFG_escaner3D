...
set_property PACKAGE_PIN U9 [get_ports {enable_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {enable_sw}]
#Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {direccion_sw}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {direccion_sw}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {MS3}]					
...
#set_property PACKAGE_PIN U4 [get_ports {S}]					
...
#set_property PACKAGE_PIN T8 [get_ports {Led_enable}]					
...
#set_property PACKAGE_PIN P5 [get_ports {ledcont[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledcont[0]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {ledcont[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledcont[1]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {ledcont[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledcont[2]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {ledcont[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledcont[3]}]
...
#set_property PACKAGE_PIN E16 [get_ports direccion]						
#	set_property IOSTANDARD LVCMOS33 [get_ports direccion]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
#set_property PACKAGE_PIN F15 [get_ports BTN_est]						
#	set_property IOSTANDARD LVCMOS33 [get_ports BTN_est]
#Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports S]						
#	set_property IOSTANDARD LVCMOS33 [get_ports S]
#Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports btn[1]]						
#set_property IOSTANDARD LVCMOS33 [get_ports btn[1]]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports BTN_dw]						
#	set_property IOSTANDARD LVCMOS33 [get_ports BTN_dw]
 


#Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
#set_property PACKAGE_PIN B13 [get_ports {DIR}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {DIR}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {DIR}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DIR}]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3  
set_property PACKAGE_PIN D17 [get_ports {STEP}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {STEP}]
#Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {ENABLE}]					
...
#set_property PACKAGE_PIN P15 [get_ports {DIR}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {DIR}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
#set_property PACKAGE_PIN V11 [get_ports {STEP}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {STEP}]
